...
function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-500/20 via-gray-50 to-secondary-500/20 dark:from-primary-900/20 dark:via-slate-900 dark:to-secondary-900/20 px-4 py-12">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-6 sm:mb-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 mt-2">Join ConnectHub and start connecting</p>
                </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-5 sm:p-8 border border-gray-100 dark:border-slate-700">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 px-4 bg-primary-500 hover:bg-primary-600 text-white font-semibold rounded-xl shadow-lg shadow-primary-500/30 transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-6"
                        >
                            {loading ? (
